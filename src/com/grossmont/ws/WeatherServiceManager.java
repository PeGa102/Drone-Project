...
public class WeatherServiceManager{
    ...
    public float getCityName(){
        ...
        return Float.parseFloat(m_oWeather.name.toString());
    ...
    public static void main(String[] args){
        ...
        WeatherServiceManager weatherServiceManager1 = new WeatherServiceManager();
        WeatherServiceManager weatherServiceManager2 = new WeatherServiceManager();
        ...
        sCity1 = sCity1.replaceAll(" City1","%20");
        sCity2 = sCity2.replaceAll(" City2","%20");
		// 3. Call callWeatherWebService on each WeatherServiceManager instance passing in each city.

        weatherServiceManager1.callWeatherWebService(sCity1);
        weatherServiceManager2.callWeatherWebService(sCity2);
        ...
        if(weatherServiceManager1.getHighTemp() > weatherServiceManager2.getHighTemp()){
            System.out.println( sCity1 + " has the highest temperature");
        }
        else{
            System.out.println(sCity2 + " has the highest temperature");
        }
        if(weatherServiceManager1.getLowTemp() < weatherServiceManager2.getLowTemp()){
            System.out.println( sCity1 + " has the lowest temperature");
        }
        else{
            System.out.println(sCity2 + " has the lowest temperature");
        }


        if(weatherServiceManager1.getHighTemp() - weatherServiceManager1.getLowTemp() >
                weatherServiceManager2.getHighTemp() - weatherServiceManager2.getLowTemp()) {
            System.out.println(sCity1 + " has the highest range");
        }
        else{
            System.out.println(sCity2 + " has the highest range");
        }
